export const frontPageMockData = {
  blocks: [
    {
      blockType: 'lead',
      title: 'Főcím1',
    ...
    },
    {
      blockType: 'content',
      title: 'Főcím3',
      description: 'Sed purus purus, maximus id ex ac, lobortis tempus ex. Ut aliquet nulla rutrum elit commodo, ut posuere purus hendrerit. Donec et gravida ante. Vivamus dui est, feugiat nec lorem vitae, maximus congue ipsum. Quisque malesuada est libero, sit amet blandit nisl aliquet eget. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Suspendisse eu auctor sapien. Quisque vel tincidunt mauris. Praesent id felis nec leo dignissim pharetra sed a massa. Praesent lacinia ex nec urna finibus commodo. Pellentesque elit velit, luctus et elit vel, semper rhoncus ipsum.',
      image: 'https://picsum.photos/600/600',
      imagePosition: 'right',
    }
  ],
